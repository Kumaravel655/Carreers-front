  ...
  return (
    <div className={styles.formContainer}>
        ...
        <div className={styles.formRow}>
          <div className={styles.formGroup}>
            ...
            <div className={styles.uploadBox}>
              ...
              <p>4 photos larger than 400 pixels work best. Max photo size 5 MB</p>
            </div>
          </div>
          <div className={styles.formGroup}>
      ...
      <div className={styles.resumeList}>
        <div className={styles.addResumeCard} onClick={() => setIsModalOpen(true)}>
      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
        ...
        <input type="text" placeholder="Cv/Resume Name" className={styles.modalInput} />
